...
// HLDRelo helps your migrate your existing Uniswap LP tokens to HaloDeFi LP ones
// Deprecated
contract HLDRelo {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'HldSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'HLDRelo: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'HLDRelo: INSUFFICIENT_B_AMOUNT');
    }
