...
contract ERC20 is ERC20Data {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(block.timestamp < deadline, 'xHLD2: Expired');
        ...
        require(recoveredAddress == owner, 'xHLD2: Invalid Signature');
        allowance[owner][spender] = value;
        emit Approval(owner, spender, value);
    }
}

contract HaloBazaar is ERC20, Ownable {
    using BoringMath for uint256;
    
    string public name = "HaloBazaar V2";
    string public symbol = "xHLD2";
    uint8 public decimals = 18;
    IERC20 public hld = IERC20(0x6B3595068778DD592e39A122f4f5a5cF09C90fE2);
    ...
    function setBonus(address sender, uint256 newBonus) public onlyOwner {
        require(newBonus <= 365 days, "HaloBazaar: Bonus too large");
    ...
    function enter(uint256 amount, address to) public {
        ...
        if (balanceCurrent == 0) {
            ...
            // If you added 100 HLD 3 months ago and you add 200 HLD now, startTime should become 1 month ago
        ...
        hld.transferFrom(msg.sender, address(this), amount);
